...
-- 		print(string.format("LibMapNotes.modify(%s, %s, newdata)", zone2modify, idx))
...
--       self.db.puzzles   =  Library.LibMapNotes.puzzles()
--	--       self.db.cairns    =  __cairns()
--       self.db.cairns    =  Library.LibMapNotes.cairns()
